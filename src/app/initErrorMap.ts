...
import { AuthorizationError } from "./middleware/authorizationVerificationMiddleware";
...
export const initErrorMap = function(){
    ...
    errorMap.set(AuthorizationError.UNAUTHORIZED,{status:401,err:{error:AuthorizationError.UNAUTHORIZED.message,error_detail:""}})
